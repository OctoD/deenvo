...
Deno.test("stack", () => {
  ...
  assertEquals(
    mystack.call()[2].unwrap(),
    stackable1(),
    "stackable1 return value is wrong",
  );
  assertEquals(
    mystack.call()[1].unwrap(),
    stackable2(),
    "stackable2 return value is wrong",
  );
  assertEquals(
    mystack.call()[0].unwrap(),
    stackable3(),
    "stackable3 return value is wrong",
  );
});
...
Deno.test("stack (call with params)", () => {
  ...
  assertEquals(
    mystack.call(10)[2].unwrap(),
    100,
    "stackable1 return value is wrong",
  );
  assertEquals(
    mystack.call(10)[1].unwrap(),
    12,
    "stackable2 return value is wrong",
  );
  assertEquals(
    mystack.call(10)[0].unwrap(),
    5,
    "stackable3 return value is wrong",
  );
});
...
Deno.test("stack (call-async with params)", async () => {
  ...
  assertEquals(
    (await mystack.callasync(10)).length,
    3,
    "stack length is wrong",
  );
  assertEquals(
    (await mystack.callasync(10))[2].unwrap(),
    100,
    "stackable1 return value is wrong",
  );
  assertEquals(
    (await mystack.callasync(10))[1].unwrap(),
    12,
    "stackable2 return value is wrong",
  );
  assertEquals(
    (await mystack.callasync(10))[0].unwrap(),
    5,
    "stackable3 return value is wrong",
  );
});
